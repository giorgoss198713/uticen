select 
cat3.client_id, cat3.client_id_brand, cat3.pool, cat3.brand_name, cat3.ftd_date,  cat3.deposit_last_day, cat3.deposit_five_days_before, cat3.client_in_email_list_cat3,
